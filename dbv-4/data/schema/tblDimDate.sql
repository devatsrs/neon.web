CREATE TABLE `tblDimDate` (
  ...
  `date` date NOT NULL,
  `day` char(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `day_abbrev` char(4) COLLATE utf8_unicode_ci DEFAULT NULL,
  `day_of_week` int(11) DEFAULT NULL,
  `day_of_month` int(11) DEFAULT NULL,
  `day_of_quarter` int(11) DEFAULT NULL,
  `day_of_semester` int(11) DEFAULT NULL,
  `day_of_year` int(11) DEFAULT NULL,
  `weekend` char(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Weekday',
  ...
  `month` char(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `month_abbrev` char(4) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `end_week` date NOT NULL DEFAULT '0000-00-00',
  `start_month` date NOT NULL DEFAULT '0000-00-00',
  `end_month` date NOT NULL DEFAULT '0000-00-00',
  `start_quarter` date NOT NULL DEFAULT '0000-00-00',
  `end_quarter` date NOT NULL DEFAULT '0000-00-00',
