...
SET v_OffSet_ = p_Start;
   ...
   CREATE TEMPORARY TABLE IF NOT EXISTS tmp_actvity_timeline_(
	...
	INSERT INTO tmp_actvity_timeline_
	select 2 as Timeline_type,'' as TaskTitle,'' as TaskName,'' as TaskPriority, '0000-00-00 00:00:00' as DueDate, '' as TaskDescription,'' as TaskStatus, Emailfrom, EmailTo,	
	...
	INSERT INTO tmp_actvity_timeline_
	select 3 as Timeline_type,'' as TaskTitle,'' as TaskName,'' as TaskPriority, '0000-00-00 00:00:00' as DueDate, '' as TaskDescription,'' as TaskStatus,'' as Emailfrom ,'' as EmailTo,'' as EmailToName,'' as EmailSubject,'' as Message,''as EmailCc,''as EmailBcc,''as EmailAttachments,0 as AccountEmailLogID,NoteID,Note,created_by,created_at,updated_at from `tblNote` where (`CompanyID` = '1' and `AccountID` = p_AccountID) order by created_at desc;
