CREATE TABLE `tblAccountBalanceHistory` (
  ...
  `TemporaryCredit` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0.000000',
  `BalanceThreshold` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0.000000',
