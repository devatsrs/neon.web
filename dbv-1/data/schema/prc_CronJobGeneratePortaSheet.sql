        ...
        from    (
                SELECT  RateId ,
                        ...
                        ELSE
                            tblTrunk.AreaPrefix
                        END AS AreaPrefix,
                        @row_num := IF(@prev_RateID=tblCustomerRate.RateID and @prev_effectivedate >= tblCustomerRate.effectivedate AND @prev_TrunkId  = tblCustomerRate.TrunkId ,@row_num+1,1) AS RowID,
