...
use App\GoCardlessPro\Core\Exception\ApiException;
...
class ApiClient
{
     ...
     * @param \App\Lib\GuzzleHttp\ClientInterface $http_client  An HTTP client to make requests
     */
     ...
     *
     * @param \App\Lib\GuzzleHttp\Psr7\Response $response The raw API response
     */
    private function handleErrors($response)
    {
        ...
        $exception_class = 'App\\GoCardlessPro\\Core\\Exception\\' . $exception_class;
