...
class RetryMiddlewareFactory
{
     ...
     * @return \App\Lib\GuzzleHttp\RetryMiddleware
     */
    public static function buildMiddleware()
    {
        return \App\Lib\GuzzleHttp\Middleware::retry(self::buildRetryDecider(), self::buildRetryDelay());
    }
    ...
    private static function buildRetryDecider()
    {
        return function (
            $retries,
            \App\Lib\GuzzleHttp\Psr7\Request $request,
            \App\Lib\GuzzleHttp\Psr7\Response $response = null,
            \App\Lib\GuzzleHttp\Exception\RequestException $exception = null
        ) {
     ...
     * @return boolean
    */
    private static function isConnectionError(\App\Lib\GuzzleHttp\Exception\RequestException $exception = null)
    {
        return $exception instanceof \App\Lib\GuzzleHttp\Exception\ConnectException;
    }
     ...
     * @return boolean
     */
    private static function isRetryableServerError(\App\Lib\GuzzleHttp\Psr7\Response $response)
    {
        if ($response) {
