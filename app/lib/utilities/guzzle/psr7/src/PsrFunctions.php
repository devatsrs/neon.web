<?php
namespace App\Lib\GuzzleHttp\Psr7;
 ...
 *
 * This public static function accepts a string or {@see Psr\Http\Message\UriInterface} and
 ...
 * contains a key, this public static function will inject a key with a '' string value.
 *
 ...
 *
 * When fopen fails, PHP normally raises a warning. This public static function adds an
...
public static function parse_request($message)
{
    ...
    $request = new Request(
        $parts[0],
        $matches[1] === '/' ? self::_parse_request_uri($parts[1], $data['headers']) : $parts[1],
        $data['headers'],
        $data['body'],
        $version
    );
 ...
 * value pair will become an array. This public static function does not parse nested
 ...
 *
 * This public static function can use the return value of parse_query() to build a query
 * string. This public static function does not modify the provided keys when an array is
