...
class SagePay
{
    ...
    public function get_paynow_button($AccountID,$InvoiceID){
        ...
        $form = '<form name="form" id="form" method="POST" action="' . $sagepay_url .'">
                  ...
                  <button name="submit"  type="submit" class="pull-right  btn btn-sm btn-danger btn-icon icon-left hidden-print"> <i class="entypo-credit-card"></i> Pay Now With SagePay</button>
                </form>';
