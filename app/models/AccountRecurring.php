...
class AccountRecurring extends \Eloquent {
	protected $fillable = [];
    protected $connection = "sqlsrv2";
    protected $table = "tblAccountRecurring";
    protected $primaryKey = "AccountRecurringID";
    protected $guarded = array('AccountRecurringID');
