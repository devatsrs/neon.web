...
class Account extends \Eloquent {
    ...
    public static function getAccountManager($AccountID){
        $managerinfo = Account::join('tblUser', 'tblUser.UserID', '=', 'tblAaccount.Owner')->where(array('AccountID'=>$AccountID))->first(['tblUser.FirstName','tblUser.LastName','tblUser.EmailAddress','tblAccount.AccountName']);
        return $managerinfo;
