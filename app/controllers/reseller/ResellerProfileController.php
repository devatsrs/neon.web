...
class ResellerProfileController extends \BaseController {
    ...
    public function show() {
        ...
        return View::make('reseller.accounts.show', compact('account', 'contacts','account_owner'));
    }
    ...
    public function edit() {
        ...
        return View::make('reseller.accounts.edit', compact('account', 'account_owners', 'countries','doc_status','currencies','timezones','taxrates','InvoiceTemplates'));
    }
