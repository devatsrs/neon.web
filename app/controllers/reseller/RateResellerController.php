...
class RateResellerController extends \BaseController {
    ...
    public function index() {
            ...
            return View::make('reseller.customersrates.index', compact('id', 'trunks', 'countries','Account','routine','trunks_routing','account_owners','trunk_keys','CurrencySymbol','displayinbound'));
    ...
    public function settings() {
            ...
            return View::make('reseller.customersrates.trunks', compact('id', 'trunks','activetrunks','displayinbound', 'customer_trunks','codedecklist','Account','rate_tables','Account','companygateway'));
    }
    ...
    public function inboundrate() {
        ...
        if($displayinbound == 0){
            return  Redirect::to('reseller/customers_rates')->with('info_message', 'No Inbound Rate table assign');
        }
        $countries = $this->countries;
        $trunks = CustomerTrunk::getTrunkDropdownIDList($id);
        $trunk_keys = getDefaultTrunk($trunks);
        ...
        $CurrencySymbol = Currency::getCurrencySymbol($Account->CurrencyId);
        return View::make('reseller.customersrates.inboundrate', compact('id', 'trunks', 'countries','Account','routine','trunks_routing','account_owners','trunk_keys','CurrencySymbol','displayinbound'));
