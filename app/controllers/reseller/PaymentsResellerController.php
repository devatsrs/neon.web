...
class PaymentsResellerController extends \BaseController {
	...
	public function index()
	{
        ...
        return View::make('reseller.payments.index', compact('id','currency','method','type','status','action','AccountID'));
	}
    ...
    public function create()
    {
        ...
        if($isvalid['valid']==1) {
            ...
            if (Payment::create($save)) {
                ...
                $data['data']['AccountName'] = Reseller::get_accountName();
                $data['data']['CreatedBy'] = Reseller::get_accountName();
