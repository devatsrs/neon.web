...
class VendorCDRTemplateController extends BaseController {
    ...
    public function index($CompanyGatewayID) {
        ...
        $UploadTemplate = FileUploadTemplate::getTemplateIDList(FileUploadTemplateType::getTemplateType(FileUploadTemplate::TEMPLATE_VENDORFTPCDR));

        return View::make('cdrtemplate.vendorupload',compact('UploadTemplate','CompanyGatewayID','Trunks','Services'));
    }
    ...
    public function storeTemplate() {
        ...
        $save['FileUploadTemplateTypeID'] = FileUploadTemplateType::getTemplateType(FileUploadTemplate::TEMPLATE_VENDORFTPCDR);
        if(isset($data['FileUploadTemplateID']) && $data['FileUploadTemplateID']>0) {
