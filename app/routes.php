...
Route::group(array('before' => 'auth'), function () {
	...
	Route::any('dealmanagement/report/customer', 'DealManagementController@customer_report');
	Route::any('dealmanagement/report/vendor', 'DealManagementController@vendor_report');
	//Pages
