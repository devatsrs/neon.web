                                        ...
                                        <div class="form-group ">
                                           ...
                                           //echo ($filter_settings['date']['date_range_filter']);die();
                                            ...
                                            <select class="select2 small" name="date_range_filter" id="date_range_filter">
                                                ...
                                                <option value="1Days" <?php if(isset($filter_settings['date']['date_range_filter']) && $filter_settings['date']['date_range_filter']=='1Days'){echo 'selected';}?>>2 Days</option>
                                                <option value="2Days" <?php if(isset($filter_settings['date']['date_range_filter']) && $filter_settings['date']['date_range_filter']=='1Days'){echo 'selected';}?>>4 Days</option>
