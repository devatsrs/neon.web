...
@section('content')
    ...
    <div class="row">
        <ul class="nav nav-tabs">
            @if($is_customer == 1)
                <li ><a href="{{ URL::to('reseller/analysis') }}">Customer</a></li>
            @endif
            @if($is_vendor == 1)
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="customer" >
                <div class="col-md-12">
                    <form novalidate class="form-horizontal form-groups-bordered filter validate" method="post" id="vendor_analysis">
