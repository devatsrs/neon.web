            ...
            <script type="text/javascript">
                $(document).ready(function($){
                    $('#account-statement-search').submit(function(e){
                        ...
                        $.ajax({
                            url: baseurl+'/reseller/account_statement/ajax_datagrid',
                            data: {
                    ...
                    $('#ToolTables_table-4_0').click(function(){
                        ...
                        var url = baseurl + "/reseller/account_statement/exports/xlsx?&StartDate="+StartDate+"&EndDate="+EndDate;
                ...
                function paymentsModel(self){
                    ...
                    $.ajax({
                        url: baseurl + '/reseller/account_statement/payment',
                        data: {
                            id: id
                        },
                        error: function () {
