        ...
        <div class="tab-pane active" id="customer_rate_tab_content">
            ...
            <script type="text/javascript">
                ...
                jQuery(document).ready(function ($) {
                    $("#payment-table-search").submit(function(e) {
                        ...
                        data_table = $("#table-4").dataTable({
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": baseurl + "/reseller/payments/ajax_datagrid/type",
                                ...
                                "aButtons": [
                                    {
                                        "sExtends": "download",
                                        "sButtonText": "EXCEL",
                                        "sUrl": baseurl + "/reseller/payments/ajax_datagrid/xlsx", //baseurl + "/generate_xlsx.php",
                                        sButtonClass: "save-collection btn-sm"
                                    },
                                    {
                                        "sExtends": "download",
                                        "sButtonText": "CSV",
                                        "sUrl": baseurl + "/reseller/payments/ajax_datagrid/csv", //baseurl + "/generate_csv.php",
                                        sButtonClass: "save-collection btn-sm"
                                    }
                                ]
                            },
                    ...
                    $('#add-edit-payment-form').submit(function(e){
                        ...
                        if( typeof PaymentID != 'undefined' && PaymentID != ''){
                            update_new_url = baseurl + '/reseller/payments/update/'+PaymentID;
                        }else{
                            update_new_url = baseurl + '/reseller/payments/create';
                        }
                ...
                function get_total_grand(){
                    $.ajax({
                        url: baseurl + "/reseller/payments/ajax_datagrid_total",
                        type: 'GET',
                        dataType: 'json',
                        data:{
