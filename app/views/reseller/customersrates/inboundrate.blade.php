...
<ul class="nav nav-tabs bordered"><!-- available classes "bordered", "right-aligned" -->
    <li>
        <a href="{{ URL::to('/reseller/customers_rates') }}" >
            Settings
        </a>
    </li>
    <li>
        <a href="{{ URL::to('/reseller/customers_rates/rate') }}" >
           Outbound Rate
        </a>
    </li>
    @if(isset($displayinbound) && $displayinbound>0)
        <li class="active">
            <a href="{{ URL::to('/reseller/customers_rates/inboundrate') }}" >
                Inbound Rate
            </a>
        </li>
    @endif
...
<div class="tab-content">
    <div class="tab-pane active" id="customer_rate_tab_content">
        ...
        <div class="row">
            <div class="col-md-12">
                <form role="form" id="customer-rate-table-search" method="post"  action="{{Request::url()}}" class="form-horizontal form-groups-bordered validate" novalidate>
                    ...
                    jQuery(document).ready(function($) {
                        ...
                        $("#customer-rate-table-search").submit(function(e) {
                            ...
                            data_table = $("#table-4").dataTable({
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": baseurl + "/reseller/customers_rates/{{$id}}/search_inbound_ajax_datagrid/type",
                                            ...
                                            "aButtons": [
                                                {
                                                    "sExtends": "download",
                                                    "sButtonText": "EXCEL",
                                                    "sUrl": baseurl + "/reseller/customers_rates/{{$id}}/search_inbound_ajax_datagrid/xlsx",
                                                    sButtonClass: "save-collection btn-sm"
                                                },
                                                {
                                                    "sExtends": "download",
                                                    "sButtonText": "CSV",
                                                    "sUrl": baseurl + "/reseller/customers_rates/{{$id}}/search_inbound_ajax_datagrid/csv",
                                                    sButtonClass: "save-collection btn-sm"
                                                }
                                            ]
                                        },
