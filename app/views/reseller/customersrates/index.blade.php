                    ...
                    jQuery(document).ready(function($) {
                        ...
                        $("#customer-rate-table-search").submit(function(e) {
                            ...
                            data_table = $("#table-4").dataTable({
                                ...
                                "bProcessing": true,
                                "bServerSide": true,
                                "sAjaxSource": baseurl + "/reseller/customers_rates/{{$id}}/search_ajax_datagrid/type",
                                            ...
                                            "aButtons": [
                                                {
                                                    "sExtends": "download",
                                                    "sButtonText": "EXCEL",
                                                    "sUrl": baseurl + "/reseller/customers_rates/{{$id}}/search_ajax_datagrid/xlsx",
                                                    sButtonClass: "save-collection btn-sm"
                                                },
                                                {
                                                    "sExtends": "download",
                                                    "sButtonText": "CSV",
                                                    "sUrl": baseurl + "/reseller/customers_rates/{{$id}}/search_ajax_datagrid/csv",
                                                    sButtonClass: "save-collection btn-sm"
                                                }
                                            ]
                                        },
