...
var postdata;
    jQuery(document).ready(function ($) {
        ...
        data_table = $("#table-4").dataTable({
            ...
            "bProcessing":true,
            "bServerSide":true,
            "sAjaxSource": baseurl + "/reseller/invoice/ajax_datagrid/type",
                ...
                "aButtons": [
                    {
                        "sExtends": "download",
                        "sButtonText": "EXCEL",
                        "sUrl": baseurl + "/reseller/invoice/ajax_datagrid/xlsx", //baseurl + "/generate_xls.php",
                        sButtonClass: "save-collection btn-sm"
                    },
                    {
                        "sExtends": "download",
                        "sButtonText": "CSV",
                        "sUrl": baseurl + "/reseller/invoice/ajax_datagrid/csv", //baseurl + "/generate_xls.php",
                        sButtonClass: "save-collection btn-sm"
                    }
                ]
            },
        ...
        function get_total_grand(){
            $.ajax({
                url: baseurl + "/reseller/invoice/ajax_datagrid_total",
                type: 'GET',
                dataType: 'json',
                data:{
        ...
        $('table tbody').on('click', '.view-invoice-in', function (ev) {
            ...
            $.ajax({
                url: baseurl + '/reseller/invoice/getInvoiceDetail',
            ...
            $("#modal-invoice-in-view").find("[data-id='"+list_fields[i]+"']").html('');
                if(list_fields[i] == 'Attachment'){
                    if(cur_obj.find("input[name='"+list_fields[i]+"']").val() != ''){
                        var down_html = ' <a href="' + baseurl +'/reseller/invoice/download_invoice_file/'+cur_obj.find("input[name='InvoiceID']").val() +'" class="edit-invoice btn btn-success btn-sm btn-icon icon-left"><i class="entypo-down"></i>Download</a>';
        ...
        $("#pay_now").click(function(ev) {
            ...
            if(InvoiceIDs.length){
                ...
                paynow_url = '/reseller/PaymentMethodProfiles/paynow';
        ...
        <form class="form-horizontal form-groups-bordered">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <span data-id="AccountName">{{Reseller::get_accountName()}}</span>
                        </div>
                     </div>
                    <div class="form-group">
