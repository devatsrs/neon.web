                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        <form id="filter-form" name="filter-form" style="display: inline" >
                            ...
                            <input name="AccountID" type="hidden" value="{{Reseller::get_accountID()}}">
                        </form>
...
function reload_invoice_expense(){
     ...
     var get_url = baseurl + "/reseller/invoice_expense_chart";
    ...
    var get_url = baseurl + "/reseller/invoice_expense_total";
