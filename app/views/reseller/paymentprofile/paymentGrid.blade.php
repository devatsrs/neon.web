...
<div class="panel panel-primary" data-collapsed="0">
    ...
    <div class="panel-body">
        ...
        <script type="text/javascript">
            var update_new_url;
            var postdata;
            var deletePaymentMethodProfile_url = "{{ URL::to('reseller/PaymentMethodProfiles/{id}/delete')}}";
            jQuery(document).ready(function ($) {
                        ...
                        {                       //3  Action
                            ...
                            mRender: function (id, type, full) {
                                var action='';
                                    ...
                                    var Active_Card = "{{ URL::to('reseller/PaymentMethodProfiles/{id}/card_status/active')}}";
                                    var DeActive_Card = "{{ URL::to('reseller/PaymentMethodProfiles/{id}/card_status/deactive')}}";
                                    var set_default = "{{ URL::to('reseller/PaymentMethodProfiles/{id}/set_default')}}";
                ...
                $('#add-credit-card-form').submit(function(e){
                    ...
                    if(cardID!=""){
                        update_new_url = baseurl + '/reseller/PaymentMethodProfiles/update';
                    }else{
                        update_new_url = baseurl + '/paymentprofile/create';
                        if(customer[0].customer==1){
                            update_new_url = baseurl + '/reseller/PaymentMethodProfiles/create';
                        }
                    }
