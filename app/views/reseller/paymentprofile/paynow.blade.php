            ...
            <script type="text/javascript">
               ...
               // jQuery(document).ready(function ($) {
                        ajax_data_table = $("#ajxtable-4").dataTable({
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": baseurl + "/reseller/PaymentMethodProfiles/ajax_datagrid",
                    ...
                    $('#add-credit-card-form').submit(function(e){
                        e.preventDefault();
                        update_new_url = baseurl + '/reseller/card/create';
                        ajax_Add_update(update_new_url);
                    });
                    $.ajax({
                        url:baseurl+'/reseller/getoutstandingamount', //Server script to process data
                        type: 'POST',
                        dataType: 'json',
               ...
               // });
                ...
                $('table tbody').on('click', '.btn.paynow', function (ev) {
                    ...
                    $.ajax({
                        url:baseurl+'/reseller/invoice/pay_now', //Server script to process data
                        type: 'POST',
                        dataType: 'json',
                        success: function(response) {
