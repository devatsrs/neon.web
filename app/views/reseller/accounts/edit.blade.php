...
<p style="text-align: right;">
    ...
    <a href="{{URL::to('reseller/profile')}}" class="btn btn-danger btn-sm btn-icon icon-left">
...
<div class="row">
<div class="col-md-12">
    <form role="form" id="account-from" method="post" action="{{URL::to('reseller/profile/update')}}" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                            ...
                            @if(Reseller::get_customer_picture_url(Reseller::get_accountID()) !='')
                            <img src="{{ Reseller::get_customer_picture_url(Reseller::get_accountID()) }}" alt="" class="img-circle" width="44" />
                            @endif
...
@include('includes.ajax_submit_script', array('formID'=>'account-from' , 'url' => ('reseller/profile/update')))
