<div class="col-md-4">
    ...
    <div class="panel loading panel-default" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
        ...
        <div class="panel-heading">
            <div class="panel-title">By Destination - Call Count.</div>
...
<div class="col-md-4">
    ...
    <div class="panel loading panel-default" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
        <!-- panel head -->
        <div class="panel-heading">
            <div class="panel-title">By Destination - Call Cost.</div>
...
<div class="col-md-4">
    ...
    <div class="panel loading panel-default" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
        <!-- panel head -->
        <div class="panel-heading">
            <div class="panel-title">By Destination - Call Minutes.</div>
...
<div class="col-md-12">
    <div class="panel loading panel-default" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
        ...
        <div class="panel-body">
            <div class="text-center">
                <div class="bar_chart_destination"></div>
            </div>
        </div>
    </div>
