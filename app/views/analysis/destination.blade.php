<div class="row">
    <div class="col-md-4">
        ...
        <div class="panel loading panel-default" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
            ...
            <div class="panel-heading">
                <div class="panel-title">@lang("routes.CUST_PANEL_ANALYSIS_TAB_DESTINATION_LBL_BY_DESTINATION_CALL_COUNT")</div>
    ...
    <div class="col-md-4">
        ...
        <div class="panel loading panel-default" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
            <!-- panel head -->
            <div class="panel-heading">
                <div class="panel-title">@lang("routes.CUST_PANEL_ANALYSIS_TAB_DESTINATION_LBL_BY_DESTINATION_CALL_COST")</div>
    ...
    <div class="col-md-4">
        ...
        <div class="panel loading panel-default" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
            <!-- panel head -->
            <div class="panel-heading">
                <div class="panel-title">@lang("routes.CUST_PANEL_ANALYSIS_TAB_DESTINATION_LBL_BY_DESTINATION_CALL_MINUTES")</div>
