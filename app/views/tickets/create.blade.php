        ...
        <form role="form" id="form-tickets-add" method="post" action="{{URL::to('tickets/create')}}" class="form-horizontal form-groups-bordered">
          ...
          <div class="form-group">
			...
			if($TicketfieldsData->FieldType == 'default_requester')
			 { 
				$required[] = array("id"=>'Ticket'.$TicketfieldsData->FieldName,"title"=>$TicketfieldsData->FieldName);
			?>
            <div class="col-sm-6">
            ...
            <?php }else{
				if($TicketfieldsData->AgentReqSubmit == '1'){$required[] = array("id"=>'Ticket'.$TicketfieldsData->FieldName,"title"=>$TicketfieldsData->AgentLabel); }
				 ?>
            <div class="col-sm-9">
              <input type="text"  name='Ticket{{$TicketfieldsData->FieldName}}' class="form-control formfld" id="Ticket{{$TicketfieldsData->FieldName}}" placeholder="{{$TicketfieldsData->AgentLabel}}" value="">
            </div>
            <?php } ?>
          </div>
          <?php
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <textarea   id='Ticket{{$TicketfieldsData->FieldName}}'  name='Ticket{{$TicketfieldsData->FieldName}}' class="form-control formfld {{$class_textarea}}" ></textarea>
          ...
          <div class="form-group">
            <label for="GroupDescription" class="col-sm-3 control-label">{{$TicketfieldsData->AgentLabel}}</label>
            <div class="col-sm-9">
              <input class="checkbox rowcheckbox formfld" value="1" name='Ticket{{$TicketfieldsData->FieldName}}' id='Ticket{{$TicketfieldsData->FieldName}}' type="checkbox">
            </div>
          </div>
          <?php 		  
				 }
          ...
          <div class="form-group">
            <label for="GroupName" class="col-sm-3 control-label">{{$TicketfieldsData->AgentLabel}}</label>
            <div class="col-sm-9">
              <input type="number" name='Ticket{{$TicketfieldsData->FieldName}}'  class="form-control formfld" id="Ticket{{$TicketfieldsData->FieldName}}" placeholder="{{$TicketfieldsData->AgentLabel}}" value="">
            </div>
          </div>
          <?php		 
				 }
            ...
            <div class="col-sm-9">
			  ...
			  if($TicketfieldsData->FieldType == 'default_priority'){
				...
				{	 
					...
					foreach($FieldValues as $FieldValuesData){
					?>
                <option value="{{$FieldValuesData->FieldsID}}">{{$FieldValuesData->FieldValueAgent}}</option>
                <?php
					}
				}
		...
		function validate_form()
		{
			 ...
			 var error_msg = '';
				...
				required_flds_data.forEach(function(element) {
					var  CurrentElementVal = 	$('#'+element.id).val();  console.log(CurrentElementVal);
