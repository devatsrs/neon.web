      ...
      <div class="panel-body">
        <form role="form" id="form-ticketgroup-add" method="post" action="{{URL::to('ticketgroups/create')}}"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              {{Form::select('GroupAgent[]', $Agents, '' ,array("class"=>"select2","multiple"=>"multiple","id"=>"GroupAgent"))}}
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <div class="input-group"> <span class="input-group-addon"><i class="entypo-mail"></i></span>
                <input name='GroupEmailAddress' id="GroupEmailAddress" type="email" class="form-control" placeholder="Email" value="{{Input::old('GroupEmailAddress')}}">
              </div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-9">
            {{Form::select('GroupAssignTime', TicketGroups::$EscalationTimes, '' ,array("class"=>"select2","id"=>"GroupAssignTime"))}}     
            </div>
          </div>
          <div class="form-group">
            <label for="field-1" class="col-sm-3 control-label">Mail to:</label>
            <div class="col-sm-9">
             {{Form::select('GroupAssignEmail', $AllUsers, '' ,array("class"=>"select2","id"=>"GroupAssignEmail"))}}              
            </div>
          </div>
          <div class="form-group">
            <label for="GroupAuomatedReply" class="col-sm-3 control-label">Automated Reply</label>
            <div class="col-sm-9">
              <textarea id="GroupAuomatedReply" name="GroupAuomatedReply" class="form-control wysihtml5box" >{{Input::old('GroupAuomatedReply')}}</textarea>
            </div>
          </div>
        </form>
      </div>
