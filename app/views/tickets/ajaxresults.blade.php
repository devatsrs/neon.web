<table id="table-4" class="table table-bordered datatable dataTable">
  ...
  <tbody>
    ...
    <tr><!-- new email class: unread -->
      ...
      <td class="col-name"><a href="{{URL::to('/')}}/tickets/{{$result_data->TicketID}}/detail" class="col-name"> <span class="blue_link"> <?php echo ShortName($result_data->Subject,100); ?></span> </a> <span class="ticket_number"> #<?php echo $result_data->TicketID; ?></span> {{get_ticket_response_due_label($result_data)}} <br>
