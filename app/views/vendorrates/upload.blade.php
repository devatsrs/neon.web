            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body" id="mapping">
                    ...
                    <div class="form-group">
                        <br />
                        <br />
                        <label for="field-1" class="col-sm-2 control-label">Forbidden <span class="label label-info popover-primary" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="0-UnBlock Vendor Rate,1-Block Vendor Rate" data-original-title="Forbidden">?</span></label>
                        <div class="col-sm-4">
