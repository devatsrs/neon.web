...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td class="col-md-6 text-right" valign="top">
           ...
           @if(isset($editable))
           <p><a href="#" id="InvoiceTemplateHeader" title="Invoice Header Content" data-inputclass="editable-textarea" class="invoice-editable form-control autogrow " style="height: auto" data-name="Header" data-type="textarea" data-placeholder="" data-title="Header">@if(trim($InvoiceTemplate->Header)=='')Invoice Company Name {{PHP_EOL}}Address {{PHP_EOL}}Country {{PHP_EOL}}Email @else{{($InvoiceTemplate->Header)}}@endif</a></p>
           <h3><a href="#" style="display: none;" id="InvoiceTemplateName" class="invoice-editable form-control" data-name="Name" data-type="text" title="Template Name">{{$InvoiceTemplate->Name}}</a></h3>
           @else
