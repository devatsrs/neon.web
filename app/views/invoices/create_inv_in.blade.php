...
<ol class="breadcrumb bc-3">
    ...
    <li class="active">
        <strong>Create New Invoice Received </strong>
    </li>
</ol>
<h3>Create New Invoice Received </h3>
...
<form class="form-horizontal form-groups-bordered" action="{{URL::to('/invoice/store_inv_in')}}" method="post" id="invoice-from" role="form">
  <p class="text-right">
    ...
    <div class="panel-body">
      <div class="form-group">
        <div class="col-sm-6">
          ...
          <div class="col-sm-9"> {{Form::text('InvoiceNumber','',array("Placeholder"=>"", "class"=>"form-control"))}} </div>
            <div class="clearfix margin-bottom "></div>
            <label for="field-1" class="col-sm-3 control-label">Status</label>
            <div class="col-sm-9">{{Form::select('InvoiceStatus',Invoice::getStatusDropDownPurchaseInvoice(),'',array("class"=>"select2"))}} </div>
          <div class="clearfix margin-bottom "></div>
           <label for="field-1" class="col-sm-3 control-label">Description</label>
          <div class="col-sm-9"> {{Form::textarea('Description','',array( "ID"=>"Account_Address", "rows"=>4, "class"=>"form-control"))}} </div>

        </div>
        
        <div class="col-sm-6">
          <label for="field-1" class="col-sm-4 control-label">Date of issue</label>
          <div class="col-sm-8"> {{Form::text('IssueDate',date('d-m-Y'),array("class"=>" form-control datepicker" , "data-startdate"=>date('d-m-Y',strtotime("-2 month")),  "data-date-format"=>"dd-mm-yyyy", "data-end-date"=>"+1w" ,"data-start-view"=>"2"))}} </div>
          <div class="clearfix margin-bottom "></div>

          <label for="field-1" class="col-sm-4 control-label">Start Date</label>
          <div class="col-sm-8"> {{Form::text('StartDate',date('d-m-Y'),array("class"=>" form-control datepicker" , "data-startdate"=>date('Y-m-d',strtotime("-2 month")),  "data-date-format"=>"dd-mm-yyyy", "data-end-date"=>"+1w" ,"data-start-view"=>"2"))}} </div>
          <div class="clearfix margin-bottom "></div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
                    ...
                    <tfoot>
                            <tr>
                                    <td >Sub Total</td>
                                    <td>{{Form::text('SubTotal','',array("class"=>"form-control SubTotal text-right"))}}</td>
                            </tr>
                            <tr class="tax_rows_invoice">
                                    <td ><span class="product_tax_title">VAT</span> </td>
                                    <td>{{Form::text('TotalTax','',array("class"=>"form-control TotalTax text-right"))}}</td>
                            </tr>
                            <!--<tr>
                                    <td>Discount </td>
                            ...
                            <tr class="grand_total_invoice">
                                    <td >Invoice Total </td>
                                    <td>{{Form::text('GrandTotal','',array("class"=>"form-control GrandTotal text-right"))}}</td>
                            </tr>
...
@include('includes.ajax_submit_script', array('formID'=>'invoice-from' , 'url' => 'invoice/store_inv_in','update_url'=>'invoice/{id}/update_inv_in' ))
@stop
@section('footer_ext')
@parent
