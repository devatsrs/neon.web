            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            {{ Form::select('InvoiceStatus', Invoice::get_invoice_status(), (!empty(Input::get('InvoiceStatus'))?explode(',',Input::get('InvoiceStatus')):Invoice::$defaultSelectedStatus), array("class"=>"select2","multiple","data-allow-clear"=>"true","data-placeholder"=>"Select Status")) }}
                        </div>
