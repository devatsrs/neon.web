...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td class="col-md-6" valign="top"> @if(!empty($logo)) <img src="{{get_image_data($logo)}}" style="max-width: 250px"> @endif </td>
    <td class="col-md-6 text-right" valign="top"><br>
      <strong>Invoice From:</strong>
      <p><strong>{{ nl2br($InvoiceTemplate->Header)}}</strong></p></td>
  </tr>
</table>
<br />
<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td class="col-md-6"  valign="top" ><strong>Invoice To</strong>
      <p>{{$Account->AccountName}}</p>
      <p>{{nl2br($Invoice->Address)}}</p></td>
    <td class="col-md-6 text-right"  valign="top" ><p><b>Invoice No: </b>{{$Invoice->FullInvoiceNumber}}<br>
        <b>Invoice Date: </b>{{ date($InvoiceTemplate->DateFormat,strtotime($Invoice->IssueDate))}}<br>
        <b>Due Date: </b>{{date('d-m-Y',strtotime($Invoice->IssueDate.' +'.$PaymentDueInDays.' days'))}}</p></td>
  </tr>
</table>
<br />
<h5>Items</h5>
<table border="1"  width="100%" cellpadding="0" cellspacing="0" class="invoice col-md-12 table table-bordered">
  ...
  <tr>
    ...
    --}}
    {{--
      <td class="hidden" class="text-center">
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <div class="table-responsive">
          <table border="0" width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td class="col-md-5" valign="top" width="60%"><p><a class="form-control" style="height: auto">{{nl2br($Invoice->Terms)}}</a></p></td>
              <td class="col-md-6"  valign="top" width="35%" ><table  border="1"  width="100%" cellpadding="0" cellspacing="0" class="bg_graycolor invoice_total col-md-12 table table-bordered">
                  <tfoot>
                    <tr>
