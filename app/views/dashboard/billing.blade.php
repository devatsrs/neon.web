...
@section('content')
    ...
    @endif
            ...
            <!-- VOS Account Balance -->
        @if(((count($BillingDashboardWidgets)==0) ||  in_array('BillingDashboardVOSAccountBalanceWidget',$BillingDashboardWidgets))&& User::checkCategoryPermission('BillingDashboardVOSAccountBalanceWidget','View'))
            <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-primary panel-table">
                    <div class="panel-heading">
                        ...
                        <div class="form_Sales panel-body white-bg">
                            <form novalidate class="form-horizontal form-groups-bordered"  id="frmVOSAccountBalance" action="javascript:void(0);">
                                <div class="form-group form-group-border-none">
                                    <div class="col-sm-8">
                                        <label class="col-sm-1 control-label managerLabel ">Search</label>
                                        <div class="col-sm-6"> <input value="" type="text" id="AccountBalanceSearch" name="AccountBalanceSearch" class="" placeholder="AccountName/Number">
                                            <button type="submit" id="submit_AccountBalanceSearch" class="btn btn-sm btn-primary"><i class="entypo-search"></i></button></div>
                                    </div>
                                </div>
                    ...
                    <div class="panel-body" style="max-height: 500px; overflow-y: auto; overflow-x: hidden;">
                        <table id="VOSAccountBalance" class="table table-responsive">
                            <thead>
                            <tr>
                                <th>Account Name</th>
        ...
        @endif
        <!-- Vos Account Balance End -->


        <!-- VOS Account IP -->
        @if(((count($BillingDashboardWidgets)==0) ||  in_array('BillingDashboardVOSAccountIPWidget',$BillingDashboardWidgets))&& User::checkCategoryPermission('BillingDashboardVOSAccountIPWidget','View'))
            ...
            <div class="col-sm-12">
                <div class="panel panel-primary panel-table">
                    <div class="panel-heading">
                        ...
                        <div class="form_Sales panel-body white-bg">
                            <form novalidate class="form-horizontal form-groups-bordered"  id="frmVOSAccountIP" action="javascript:void(0);">
                                <div class="form-group form-group-border-none">
                                    <div class="col-sm-8">
                                        <label class="col-sm-1 control-label managerLabel ">Search</label>
                                        <div class="col-sm-6"> <input value="" type="text" id="AccountIPSearch" name="AccountIPSearch" class="" placeholder="AccountName/IP">
                                            <button type="submit" id="submit_AccountIPSearch" class="btn btn-sm btn-primary"><i class="entypo-search"></i></button></div>
                                    </div>
                                </div>
                    ...
                    <div class="panel-body" style="max-height: 500px; overflow-y: auto;">
                        <table id="VOSAccountIP" class="table table-responsive">
                            <thead>
                            <tr>
                                <th>Account Name</th>
                                <th>IPs</th>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function ($) {
            ...
            /*START VOS AccountBalance Grid*/
            var AccountBalanceSearch = $("#frmVOSAccountBalance [name='AccountBalanceSearch']").val();
           var VOSAccountBalanceDatatable= $("#VOSAccountBalance").dataTable({
                "bDestroy": true,
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": baseurl + "/billing_dashboard/VOS_AccountBalance/ajax_datagrid/type",
                "fnServerParams": function (aoData) {
                    aoData.push(
                            { "name": "AccountBalanceSearch", "value": AccountBalanceSearch });
                ...
                "aoColumns": [
                    ...
                    {  "bSortable": true },  // 2 Account Number
                    {  "bSortable": true},  // 3 Account Balance
                    ...
                    "aButtons": [
                        {
                            "sExtends": "download",
                            "sButtonText": "EXCEL",
                            "sUrl": baseurl + "/billing_dashboard/VOS_AccountBalance/ajax_datagrid/xlsx",
                            sButtonClass: "save-collection btn-sm"
                        },
                        {
                            "sExtends": "download",
                            "sButtonText": "CSV",
                            "sUrl": baseurl + "/billing_dashboard/VOS_AccountBalance/ajax_datagrid/csv",
                            sButtonClass: "save-collection btn-sm"
                        }
                    ]
                },
            ...
            $("#submit_AccountBalanceSearch").click(function(e){
                e.preventDefault();
                AccountBalanceSearch = $("#frmVOSAccountBalance [name='AccountBalanceSearch']").val();
                VOSAccountBalanceDatatable.fnFilter('', 0);
                return false;
            });

            /*END VOS AccountBalance Grid*/

            /*START VOS AccountIP Grid*/
            var AccountIPSearch = $("#frmVOSAccountIP [name='AccountIPSearch']").val();
            var VOSAccountIPDatatable= $("#VOSAccountIP").dataTable({
                "bDestroy": true,
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": baseurl + "/billing_dashboard/VOS_AccountIP/ajax_datagrid/type",
                "fnServerParams": function (aoData) {
                    aoData.push(
                            { "name": "AccountIPSearch", "value": AccountIPSearch });
                ...
                "aoColumns": [
                    ...
                    {  "bSortable": true },  // 1 Account Name
                    {  "bSortable": false },  // 2 Account IP
                    {  "bSortable": true},  // 3 Account Type
                    ...
                    "aButtons": [
                        {
                            "sExtends": "download",
                            "sButtonText": "EXCEL",
                            "sUrl": baseurl + "/billing_dashboard/VOS_AccountIP/ajax_datagrid/xlsx",
                            sButtonClass: "save-collection btn-sm"
                        },
                        {
                            "sExtends": "download",
                            "sButtonText": "CSV",
                            "sUrl": baseurl + "/billing_dashboard/VOS_AccountIP/ajax_datagrid/csv",
                            sButtonClass: "save-collection btn-sm"
                        }
                    ]
                },
            ...
            $("#submit_AccountIPSearch").click(function(e){
                e.preventDefault();
                AccountIPSearch = $("#frmVOSAccountIP [name='AccountIPSearch']").val();
                VOSAccountIPDatatable.fnFilter('', 0);
                return false;
            });

            /*END VOS Account IP Grid*/
