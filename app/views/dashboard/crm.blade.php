...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="panel panel-primary panel-table">
      <div class="panel-heading">
        <div class="panel-title">
          <h1>My Sales Forecast</h1>
          <div class="forecastResult"></div>
        </div>
        <div id="Forecast" class="panel-options"> <a data-rel="collapse" href="#"><i class="entypo-down-open"></i></a> <a data-rel="reload" href="#"><i class="entypo-arrows-ccw"></i></a> <a data-rel="close" href="#"><i class="entypo-cancel"></i></a> </div>
        ...
        <div class="clear clearfix margin-bottom"></div>
          ...
          <div class="form-group">
           <label  class="col-sm-2 control-label">Status</label>
            <div class="col-sm-6">{{Form::select('Status[]', Opportunity::$status, Opportunity::$defaultSelectedStatus ,array("class"=>"select2","multiple"=>"multiple"))}}</div>
