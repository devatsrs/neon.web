...
<script type="text/javascript">
    ...
    jQuery(document).ready(function($) {
        ...
        data_table = $("#table-4").dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": baseurl + "/cronjobs/history_ajax_datagrid/{{$id}}/type/app",
                        ...
                        "aButtons": [
                            {
                                "sExtends": "download",
                                "sButtonText": "EXCEL",
                                "sUrl": baseurl + "/cronjobs/history_ajax_datagrid/{{$id}}/xlsx/app",
                                sButtonClass: "save-collection btn-sm"
                            },
                            {
                                "sExtends": "download",
                                "sButtonText": "CSV",
                                "sUrl": baseurl + "/cronjobs/history_ajax_datagrid/{{$id}}/csv/app",
                                sButtonClass: "save-collection btn-sm"
                            }
                        ]
                    }
