<div class="form-group">
    ...
    <div class="col-sm-4">
        {{Form::select('selection[disconnect_datetime]', $columns,(isset($attrselection->disconnect_datetime)?$attrselection->disconnect_datetime:''),array("class"=>"select2 small"))}}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        {{Form::select('selection[CallID]', $columns,(isset($attrselection->CallID)?$attrselection->CallID:''),array("class"=>"select2 small"))}}
    </div>
</div>
<div class="form-group">
