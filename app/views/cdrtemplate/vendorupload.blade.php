...
<ol class="breadcrumb bc-3">
    ...
    <li class="active">
        <strong>FTP VENDOR CDR Mapping</strong>
    </li>
</ol>
<h3>FTP VENDOR CDR Mapping</h3>
...
var is_upload=0;
    jQuery(document).ready(function ($) {
        ...
        $('#bulk_upload').submit(function(e){
            e.preventDefault();
            update_new_url = '{{URL::to('vendor_cdr_template/check_upload')}}';
        ...
        $('#check_upload').click(function(e){
                ...
                update_new_url = '{{URL::to('vendor_cdr_template/ajaxfilegrid')}}';
            ...
            $("#save_template").click(function(e){
                ...
                if(FileUploadTemplateID!='' && is_upload==0){
                    ...
                    update_new_url = '{{URL::to('vendor_cdr_template/updateTemplate')}}';
                }else{
                    console.log("store template");
                    update_new_url = '{{URL::to('vendor_cdr_template/storeTemplate')}}';
                }
    ...
    $("select[name=FileUploadTemplateID]").change(function (ev) {
        ...
        if(FileUploadTemplateID > 0){
            ...
            $.ajax({url: '{{URL::to('vendor_cdr_template/edittemplate')}}/'+FileUploadTemplateID,
                success: function(response){
                if (response.status == 'success') {
                    reloadJobsDrodown(0);
                    var data = response.data;
