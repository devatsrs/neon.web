                ...
                <div class="tab-pane" id="tab2-3">
                    ...
                    <div class="subcategorycontent" id="subcategorycontent{{$XeroDbData->Slug}}">
                        ...
                        <div class="panel panel-primary" data-collapsed="0">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    Chart of Accounts Mapping - Items (For Invoice Posting)
                                </div>
                            ...
                            <div class="panel-body">
                                <?php $count=0; ?>
                                @if(!empty($Products[1])&& count($Products[1])>0)
                                    @foreach($Products[1] as $key=>$Prod)
                                        <div class="col-md-6  margin-top">
                                            <div class="form-group">
                                                <label for="field-1" class="col-sm-4 control-label">{{$Prod}}:</label>
                                                <div class="col-sm-8">
                                                    <input type="text"  class="form-control" name="Items[{{$key}}]" value="{{isset($XeroData['Items'][$key])?$XeroData['Items'][$key]:""}}" />
                                                </div>
                                            </div>
                                        </div>
                                        <?php $count++; ?>
                        ...
                        <div class="panel panel-primary" data-collapsed="0">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    Chart of Accounts Mapping - Subscriptions (For Invoice Posting)
                                </div>
                            ...
                            <div class="panel-body">
                                <?php $count=0; ?>
                                @if(!empty($Products[3])&& count($Products[3])>0)
                                    @foreach($Products[3] as $key=>$Prod)
                                        <div class="col-md-6  margin-top">
                                            <div class="form-group">
                                                <label for="field-1" class="col-sm-4 control-label">{{$Prod}}:</label>
                                                <div class="col-sm-8">
                                                    <input type="text"  class="form-control" name="Subscriptions[{{$key}}]" value="{{isset($XeroData['Subscriptions'][$key])?$XeroData['Subscriptions'][$key]:""}}" />
                                                </div>
                                            </div>
                                        </div>
                                        <?php $count++; ?>
