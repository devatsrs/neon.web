...
{{--<link rel="stylesheet" type="text/css" href="assets/js/daterangepicker/daterangepicker-bs3.css" />--}}
    ...
    <ul class="nav nav-tabs">
        @if($is_customer == 1)
            <li class="active"><a href="#">@lang("routes.CUST_PANEL_ANALYSIS_TAB_CUSTOMER_TITLE")</a></li>
        @endif
        @if($is_vendor == 1)
            <li ><a href="{{ URL::to('customer/vendor_analysis') }}">@lang("routes.CUST_PANEL_ANALYSIS_TAB_VENDOR_TITLE")</a></li>
        @endif
    </ul>
                    ...
                    <div data-collapsed="0" class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-1 control-label" for="field-1">@lang("routes.CUST_PANEL_ANALYSIS_FILTER_FIELD_START_DATE")</label>
                                ...
                                <label class="col-sm-1 control-label" for="field-1">@lang("routes.CUST_PANEL_ANALYSIS_FILTER_FIELD_END_DATE")</label>
                                <div class="col-sm-2" style="padding-left:0; padding-right:0; width:10%;">
                                ...
                                <label class="col-sm-1 control-label" for="field-1">@lang("routes.CUST_PANEL_ANALYSIS_FILTER_FIELD_COUNTRY")</label>
                                <div class="col-sm-2">
                                    {{ Form::select('CountryID',$Country,'', array("class"=>"select2")) }}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label" for="field-1">@lang("routes.CUST_PANEL_ANALYSIS_FILTER_FIELD_PREFIX")</label>
                                <div class="col-sm-2">
                                    <input type="text" name="Prefix"  class="form-control"/>
                                </div>
                                    <label class="col-sm-1 control-label" for="field-1">@lang("routes.CUST_PANEL_ANALYSIS_FILTER_FIELD_TRUNK")</label>
                                <div class="col-sm-2">
                                    {{ Form::select('TrunkID',$trunks,'', array("class"=>"select2")) }}
                                </div>
                                <label class="col-sm-1 control-label select_hour" for="field-1">@lang("routes.CUST_PANEL_ANALYSIS_FILTER_FIELD_TIMEZONE")</label>
                                <div class="col-sm-2 select_hour">
                                    {{ Form::select('TimeZone',$timezones,'', array("class"=>"select2")) }}
                                </div>
                                <label class="col-sm-1 control-label" for="field-1">@lang("routes.CUST_PANEL_ANALYSIS_FILTER_FIELD_TYPE")</label>
                                <div class="col-sm-2">
    ...
    <ul class="nav nav-tabs refresh_tab">
        ...
        <li class="active"><a href="#destination" data-toggle="tab">@lang("routes.CUST_PANEL_ANALYSIS_TAB_DESTINATION_TITLE")</a></li>
        <li ><a href="#description" data-toggle="tab">@lang("routes.CUST_PANEL_ANALYSIS_TAB_DESTINATION_BREAK_TITLE")</a></li>
        <li ><a href="#prefix" data-toggle="tab">@lang("routes.CUST_PANEL_ANALYSIS_TAB_PREFIX_TITLE")</a></li>
        <li ><a href="#trunk" data-toggle="tab">@lang("routes.CUST_PANEL_ANALYSIS_TAB_TRUNK_TITLE")</a></li>
        @endif
        @if((empty($MonitorDashboardSetting)) ||  in_array('CallMonitor',$MonitorDashboardSetting))
            <li class="{{!in_array('AnalysisMonitor',$MonitorDashboardSetting)?'active':''}}"><a href="#mdn" data-toggle="tab">@lang("routes.CUST_PANEL_ANALYSIS_TAB_MOST_DIALLED_NUMBER_TITLE")</a></li>
            <li ><a href="#ldc" data-toggle="tab">@lang("routes.CUST_PANEL_ANALYSIS_TAB_LONGEST_DURATIONS_CALLS_TITLE")</a></li>
            <li ><a href="#mec" data-toggle="tab">@lang("routes.CUST_PANEL_ANALYSIS_TAB_MOST_EXPENSIVE_CALLS_TITLE")</a></li>
        @endif
    </ul>
    <div class="tab-content">
        @if( (empty($MonitorDashboardSetting)) ||  in_array('AnalysisMonitor',$MonitorDashboardSetting))
