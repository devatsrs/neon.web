...
@if( $account->PaymentMethod == 'Stripe'  || $account->PaymentMethod == 'AuthorizeNet' || $account->PaymentMethod == 'FideliPay' || $account->PaymentMethod == 'PeleCard')
	@if (is_authorize($account->CompanyId) || is_Stripe($account->CompanyId) || is_FideliPay($account->CompanyId) || is_PeleCard($account->CompanyId))
