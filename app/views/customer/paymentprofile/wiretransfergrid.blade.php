...
<div class="panel panel-primary" data-collapsed="0">
    ...
    <div class="panel-body">
        <div class="text-right">
            <a  id="add-new-bank" class=" btn btn-primary btn-sm btn-icon icon-left"><i class="entypo-plus"></i>@lang('routes.CUST_PANEL_PAGE_PAYMENT_METHOD_PROFILES_MODAL_ADD_NEW_BANK_AC_TITLE')</a>
        ...
        <script type="text/javascript">
            ...
            jQuery(document).ready(function ($) {
                ...
                $('#add-new-bank').click(function (ev) {
                    ...
                    $('#add-modal-card .modal-title').text("@lang('routes.CUST_PANEL_PAGE_PAYMENT_METHOD_PROFILES_MODAL_ADD_NEW_BANK_AC_TITLE')");
