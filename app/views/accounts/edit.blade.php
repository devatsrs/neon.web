...
<p style="text-align: right;"> <a href="javascript:void(0)" class="btn btn-primary btn-sm btn-icon icon-left opportunity"> <i class="entypo-plus"></i> Add Opportunity </a> @if($account->VerificationStatus == Account::NOT_VERIFIED) <a data-id="{{$account->AccountID}}"  class="btn btn-success btn-sm btn-icon icon-left change_verification_status"> <i class="entypo-check"></i> Verify </a> @endif <a href="{{URL::to('accounts/authenticate/'.$account->AccountID)}}" class="btn btn-primary btn-sm btn-icon icon-left"> <i class="entypo-cancel"></i> Authentication Rule </a>
  <button type="button" id="save_account" class="save btn btn-primary btn-sm btn-icon icon-left" data-loading-text="Loading..."> <i class="entypo-floppy"></i> Save </button>
  <a href="{{URL::to('/accounts')}}" class="btn btn-danger btn-sm btn-icon icon-left"> <i class="entypo-cancel"></i> Close </a> </p>
<?php $Account = $account;?>
@include('accounts.errormessage') <br>
<div class="row">
  <div class="col-md-12">
    <form role="form" id="account-from" method="post" action="{{URL::to('accounts/update/'.$account->AccountID)}}" class="form-horizontal form-groups-bordered">
        ...
        <div class="panel-body">
          <div class="form-group">
            ...
            <div class="col-sm-4">
              ...
              {{Form::select('Ownership', $ownership_array, $account->Ownership ,array("class"=>"form-control select2"))}} </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <div class="make-switch switch-small">
                <input type="checkbox" name="IsVendor"  @if($account->IsVendor == 1 )checked=""@endif value="1"> </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <div class="make-switch switch-small">
                <input type="checkbox" @if($account->IsCustomer == 1 )checked="" @endif name="IsCustomer" value="1"> </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <div class="make-switch switch-small">
                <input type="checkbox" @if($account->IsReseller == 1 )checked="" @endif name="IsReseller" value="1"> </div>
            </div>
                    <label class="col-sm-2 control-label">Active</label>
            <div class="col-sm-4">
              <div class="make-switch switch-small">
                <input type="checkbox" name="Status"  @if($account->Status == 1 )checked=""@endif value="1"> </div>
            </div>
        ...
        <label for="field-1" class="col-sm-2 control-label">Billing Email</label>
            <div class="col-sm-4">
              <input type="text" class="form-control"  name="BillingEmail" id="field-1" placeholder="" value="{{$account->BillingEmail}}" />
       		 ...
       		 <label for="ResellerEmail" class="col-sm-2 control-label">Reseller Email</label>
            <div class="col-sm-4">
              <input type="text" class="form-control"  name="ResellerEmail" id="ResellerEmail" placeholder="" value="{{$account->ResellerEmail}}" />
            </div>            
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4"> @if($invoice_count == 0)
            ...
            <div class="col-sm-4"> {{Form::select('Timezone', $timezones, $account->TimeZone ,array("class"=>"form-control select2"))}} </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">Verification Status</label>
            <div class="col-sm-4"> {{Account::$doc_status[$account->VerificationStatus]}} </div>
          ...
          <div class="form-group">
            ...
            <div class="desc col-sm-4 table_{{count($CLIList)}}" >
              <table class="table table-bordered datatable dataTable acountclitable ">
                ...
                <tr>
                  <td> {{$row2}} </td>
                  <td><a class="btn  btn-danger btn-sm btn-icon icon-left delete-cli"  href="javascript:;" ><i class="entypo-cancel"></i>Delete</a></td>
                </tr>
                @endforeach
                @endif
                  </tbody>
              ...
              <a class="btn btn-primary  btn-sm btn-icon icon-left add-cli"  href="javascript:;" ><i class="entypo-plus"></i>Add</a> </div>
            <input type="hidden" class="form-control"  name="CustomerCLI" id="field-1" placeholder="" value="{{$account->CustomerCLI}}" />
          </div>
          <div class="panel-title desc clear"> Description </div>
          <div class="form-group">
            <div class="col-sm-12">
          ...
          <div class="form-group">
            ...
            <label for="CustomerPassword" class="col-sm-2 control-label">Reseller Panel Password</label>
            <div class="col-sm-4">
              <input type="password" class="form-control"   name="ResellerPassword" id="ResellerPassword" autocomplete="off" placeholder="Enter Password" value="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="panel panel-primary" data-collapsed="0">
        <div class="panel-heading">
          <div class="panel-title"> Account Verification Document </div>
          <div class="panel-options"> <a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a> </div>
        </div>
        <div class="panel-body"> @foreach($AccountApproval as $row)
          <div class="form-group ">
            <div class="panel-title desc col-sm-3 "> @if($row->Required == 1)
              *
              @endif
              {{$row->Key}} </div>
            <div class="panel-title desc col-sm-4 table_{{$row->AccountApprovalID}}" >
              ...
              <table class="table table-bordered datatable dataTable ">
                ...
                <tr>
                  <td> {{basename($row2->FileName)}} </td>
                  <td><a class="btn btn-success btn-sm btn-icon icon-left"  href="{{URL::to('accounts/download_doc/'.$row2->AccountApprovalListID)}}" title="" ><i class="entypo-down"></i>Download</a> <a class="btn  btn-danger btn-sm btn-icon icon-left delete-doc"  href="{{URL::to('accounts/delete_doc/'.$row2->AccountApprovalListID)}}" ><i class="entypo-cancel"></i>Delete</a></td>
                </tr>
                @endforeach
                  </tbody>
            ...
            <div class="col-sm-5">
              <ul class="icheck-list">
                <li> <a class="btn btn-primary upload-doc" data-title="{{$row->Key}}" data-id="{{$row->AccountApprovalID}}"  href="javascript:;"> <i class="entypo-upload"></i> Upload Document </a> @if($row->DocumentFile !='') <a class="btn btn-success btn-sm btn-icon icon-left"  href="{{URL::to('accounts/download_doc_file/'.$row->AccountApprovalID)}}" title="" ><i class="entypo-down"></i>Download Attached File</a> @endif </li>
                <li> {{$row->Infomsg}} </li>
              </ul>
            </div>
          </div>
      ...
      <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4"> {{Form::select('Country', $countries, $account->Country ,array("class"=>"form-control select2"))}} </div>
          </div>
        </div>
      </div>
      <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">
          <div class="form-group">
            ...
            <div class="col-sm-4"> {{Form::select('TaxRateId[]', $taxrates, (isset($account->TaxRateId)? explode(',',$account->TaxRateId) : explode(',',$DefaultTextRate) ) ,array("class"=>"form-control select2",'multiple'))}} </div>
            <label for="field-1" class="col-sm-2 control-label">Billing Type*</label>
            <div class="col-sm-4"> {{Form::select('BillingType', AccountApproval::$billing_type, $account->BillingType,array('id'=>'billing_type',"class"=>"selectboxit"))}} </div>
          </div>
          <div class="form-group">
            <label for="field-1" class="col-sm-2 control-label">Billing Timezone*</label>
            <div class="col-sm-4"> {{Form::select('BillingTimezone', $timezones, ($account->BillingTimezone != ''?$account->BillingTimezone:CompanySetting::getKeyVal('BillingTimezone') ),array("class"=>"form-control select2"))}} </div>
            ...
            <div class="col-sm-4">
              ...
              {{Form::select('SendInvoiceSetting', $SendInvoiceSetting, ($account->SendInvoiceSetting != ''?$account->SendInvoiceSetting:'never' ),array("class"=>"form-control select2"))}} </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4"> {{Form::select('BillingCycleType', SortBillingType(), ($account->BillingCycleType != ''?$account->BillingCycleType:CompanySetting::getKeyVal('BillingCycleType') ),array("class"=>"form-control select2"))}} </div>
            <div id="billing_cycle_weekly" class="billing_options" style="display: none">
              ...
              <div class="col-sm-4">
                <?php $Days = array( ""=>"Please Start of Day",
                                ...
                                "saturday"=>"Saturday",
                                "sunday"=>"Sunday");?>
                {{Form::select('BillingCycleValue',$Days, ($account->BillingCycleType=='weekly'?$account->BillingCycleValue:'') ,array("class"=>"form-control select2"))}} </div>
            </div>
            <div id="billing_cycle_in_specific_days" class="billing_options" style="display: none">
              ...
              <div class="col-sm-4"> {{Form::text('BillingCycleValue', ($account->BillingCycleType=='in_specific_days'?$account->BillingCycleValue:'') ,array("data-mask"=>"decimal", "data-min"=>1, "maxlength"=>"3", "data-max"=>365, "class"=>"form-control","Placeholder"=>"Enter Billing Days"))}} </div>
            </div>
            <div id="billing_cycle_subscription" class="billing_options" style="display: none">
              ...
              <div class="col-sm-4"> {{Form::text('BillingCycleValue', ($account->BillingCycleType=='subscription'?$account->BillingCycleValue:'') ,array("data-mask"=>"decimal", "data-min"=>1, "maxlength"=>"3", "data-max"=>365, "class"=>"form-control","Placeholder"=>"Enter Subscription Qty"))}} </div>
            </div>
            <div id="billing_cycle_monthly_anniversary" class="billing_options" style="display: none">
              ...
              <div class="col-sm-4"> {{Form::text('BillingCycleValue', ($account->BillingCycleType=='monthly_anniversary'?$account->BillingCycleValue:'') ,array("class"=>"form-control datepicker","Placeholder"=>"Anniversary Date" , "data-start-date"=>"" ,"data-date-format"=>"dd-mm-yyyy", "data-end-date"=>"+1w", "data-start-view"=>"2"))}} </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4"> {{Form::select('CDRType', Account::$cdr_type, ($account->CDRType != ''?$account->CDRType:CompanySetting::getKeyVal('CDRType') ),array("class"=>"selectboxit"))}} </div>
            <label for="field-1" class="col-sm-2 control-label">Invoice Template*</label>
            <div class="col-sm-4"> {{Form::select('InvoiceTemplateID', $InvoiceTemplates, ($account->InvoiceTemplateID != ''?$account->InvoiceTemplateID:CompanySetting::getKeyVal('InvoiceTemplateID') ),array("class"=>"form-control select2"))}} </div>
          </div>
          <?php
      ...
      <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">
          <div class="form-group">
            <div class="panel-title desc col-sm-6"> Preferred Payment Method </div>
            <script>
                        var ajax_url = baseurl + "/accounts/{{$account->AccountID}}/ajax_datagrid_PaymentProfiles";
                    </script>
            <div class="col-sm-9" style="float: right;"> @if (is_authorize())
              @include('customer.paymentprofile.paymentGrid')
              @endif </div>
            <div class="col-sm-3">
              <ul class="icheck-list">
                <li>
                  <input class="icheck-11" type="radio" id="minimal-radio-1-11" name="PaymentMethod" value="Paypal" @if( $account->
                  PaymentMethod == 'Paypal' ) checked="" @endif />
                  <label for="minimal-radio-1-11">Paypal</label>
                </li>
                <li>
                  <input tabindex="8" class="icheck-11" type="radio" id="minimal-radio-2-11" name="PaymentMethod" value="Wire Transfer" @if( $account->
                  PaymentMethod == 'Wire Transfer' ) checked="" @endif />
                  <label for="minimal-radio-2-11">Wire Transfer</label>
                </li>
                <li>
                  <input type="radio" class="icheck-11" id="minimal-radio-disabled-2-11" name="PaymentMethod" value="AuthorizeNet" @if( $account->
                  PaymentMethod == 'AuthorizeNet' ) checked="" @endif />
                  <label for="minimal-radio-2-11">AuthorizeNet</label>
                </li>
                <li>
                  <input type="radio" class="icheck-11" id="minimal-radio-disabled-2-11" name="PaymentMethod" value="Other" @if( $account->
                  PaymentMethod == 'Other' ) checked="" @endif />
    ...
    <div class="modal-content">
      <form role="form" id="form-upload" method="post" action="{{URL::to('accounts/upload/'.$account->AccountID)}}"
        ...
        <div class="modal-footer">
          <button type="submit"  class="btn upload btn-primary btn-sm btn-icon icon-left" data-loading-text="Loading..."> <i class="entypo-upload"></i> Upload </button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form role="form" id="form-addcli-modal" method="post" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
          <button type="submit"  class="btn btn-primary btn-sm btn-icon icon-left"> <i class="entypo-floppy"></i> Add </button>
          <button  type="button" class="btn btn-danger btn-sm btn-icon icon-left" data-dismiss="modal"> <i class="entypo-cancel"></i> Close </button>
        </div>
      </form>
    </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="col-sm-4"> {{Form::select('UserID',$account_owners,User::get_userID(),array("class"=>"selectboxit",'disabled'))}} </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <div class="leads">
                  ...
                  <div class="col-sm-4"> {{Form::select('AccountID',$accounts,'',array("class"=>"selectboxit",'disabled'))}} </div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="col-sm-4"> {{Form::select('BoardID',$boards,'',array("class"=>"selectboxit"))}} </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div id="rating" class="col-sm-4"> <i rate-id="1" class="entypo-star"></i> <i rate-id="2" class="entypo-star"></i> <i rate-id="3" class="entypo-star"></i> <i rate-id="4" class="entypo-star"></i> <i rate-id="5" class="entypo-star"></i>
