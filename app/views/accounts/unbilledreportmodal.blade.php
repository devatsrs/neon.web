                    ...
                    <div id="report_filter" method="get" action="#">
                        <table width="100%">
                            <tr>
                                ...
                                <td width="20%">{{ Form::select('Type', [""=>"All","Oneofcharge" => "One Of Charge","PRS Earnings"=>"PRS Earnings","Subscription" => "Subscription","TopUp"=>"Top Up","Usage"=>"Usage", "Out Payment"=>"Out Payment"], '', array("class"=>"form-control select2 small")) }}</td>
