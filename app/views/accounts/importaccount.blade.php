...
@section('content')
    <ol class="breadcrumb bc-3">
        ...
        <li class="active"><strong>Import Account</strong></li>
    </ol>    <h3>Import Account</h3>

<div class="row">
<div class="col-md-12">
    <form role="form" id="form-upload" name="form-upload" method="post" action="{{URL::to('accounts/process_upload')}}" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="field-1" class="col-sm-2 control-label">Gateway</label>
                    <div class="col-sm-4">
...
jQuery(document).ready(function ($) {
    $('.btn.upload').click(function(e){
        ...
        //}else{
            ...
            show_loading_bar(0);
            $.ajax({
                url:  '{{URL::to('accounts/check_upload')}}',  //Server script to process data
                type: 'POST',
                dataType: 'json',
                beforeSend: function(){
    ...
    $('.btn.check').click(function(e){
        ...
        $.ajax({
            url:'{{URL::to('accounts/ajaxfilegrid')}}',
            type: 'POST',
            dataType: 'json',
            beforeSend: function(){
    ...
    $("#save_template").click(function(e){
        ...
        $.ajax({
            url:'{{URL::to('accounts/storeTemplate')}}', //Server script to process data
            type: 'POST',
            dataType: 'json',
            beforeSend: function(){
