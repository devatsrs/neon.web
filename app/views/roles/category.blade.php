...
@section('content')
    ...
    <ol class="breadcrumb bc-3">
        ...
        <li class="active">
            <a href="javascript:void(0)">Category Resource Mapping</a>
        </li>
    </ol>

    <h3>Category Resource Mapping</h3>
    <br>
    @if( User::is_admin() or User::is('BillingManager'))
        <p style="text-align: right;">
            <a href="#" id="add-new-category" class="btn btn-primary ">
        ...
        <form id="add-edit-role-form" method="post">
            <div class="row">
                <div class="col-md-6 leftsection">
                    <ul class="nav nav-tabs">
                        <!--<li class="active"><a href="#lefttab1" data-toggle="tab">User</a></li>
                        <li><a href="#lefttab2" id="leftgroup" data-toggle="tab">Roles</a></li>-->
                        <li class="active"><a href="#lefttab3" id="leftcategory" data-toggle="tab">Categories</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="lefttab3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        <input type="text" name="vender" class="form-control" placeholder="Category Search" value="">
                                    </div>
                                    <div class="col-sm-10 scroll">
                                            ...
                                            @if(count($resources))
                                                @foreach($resources as $index=>$resource)
                                                    <tr search="{{strtolower($resource->ResourceCategoryName)}}">
                                                        ...
                                                        <td>{{$resource->ResourceCategoryName}}
                                                        <span style="display: none;"><a class="edit-new-category" data-id="{{$resource->ResourceCategoryID}}" data-name="{{$resource->ResourceCategoryName}}">Edit</a></span>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
                ...
                <div class="col-md-6 rightsection">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#righttab4" data-toggle="tab">Actions</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="righttab2">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-sm-6">
                        ...
                        <div class="tab-pane active" id="righttab4">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        <input type="text" name="vender" class="form-control"placeholder="Action Search" value="">
                                    </div>
                                    <div class="col-sm-10 scroll">
                                        <table class="clear table table-bordered datatable controle action">
                                            <thead>
                                            <tr>
                                                <th width="10%">
                                                    <div class="checkbox">
                                            ...
                                            @if(count($actions))
                                                @foreach($actions as $index=>$action)
                                                    <tr search="{{strtolower($action)}}">
                                                        <td>
                                                            <div class="checkbox">
                                                                {{Form::checkbox("ActionIds[]" , $index ) }}
                                                            </div>
                                                        </td>
                                                        <td>{{$action}}</td>
                                                    </tr>
            ...
            <script type="text/javascript">
                ...
                jQuery(document).ready(function ($) {
                    disable();
                    $('#add-new-category,#add-new-permission').on('click',function(e){
                        e.preventDefault();
                        var self = $(this);
                        if(self.attr('id')=='add-new-category'){
                            $('#add-modal-role-permission .role').show();
                            $('#add-modal-role-permission .permission').hide();
                            $('#add-modal-role-permission h4').text('Add New Category');
                            $('#add-role-permission-form').find('[name="type"]').val('category');
                        }else{
                    ...
                    $('.edit-new-category').on('click',function(e){
                        e.preventDefault();
                        var self = $(this);
                        var id = self.attr("data-id");
                        var name = self.attr("data-name");
                        if(self.attr('class')=='edit-new-category'){
                            $('#edit-modal-role-permission .role').show();
                            $('#edit-modal-role-permission h4').text('Edit New Category');
                            $('#edit-role-permission-form').find('[name="type"]').val('category');
                            $('#edit-role-permission-form').find('[name="ResourceCategoryName"]').val(name);
                            $('#edit-role-permission-form').find('[name="ResourceCategoryID"]').val(id);
                        }
                        $('#edit-modal-role-permission').modal('show');
                    });
                    ...
                    $('#add-role-permission-form').submit(function(e){
                        ...
                        var url = baseurl + '/roles/storecategory';
                        if(type=='permission'){
                    ...
                    $('#edit-role-permission-form').submit(function(e){
                        e.preventDefault();
                        var type = $('#edit-role-permission-form').find('[name="type"]').val();
                        var formData = new FormData($('#edit-role-permission-form')[0]);
                        var url = baseurl + '/roles/storecategory';
                        $.ajax({
                            url: url,  //Server script to process data
                            type: 'POST',
                    ...
                    $('#add-edit-role-form').submit(function(e){
                        ...
                        var url = baseurl + '/roles/categoryupdate';
                        $.ajax({
                            url: url,  //Server script to process data
                            type: 'POST',
                    ...
                    function getdata() {
                        ...
                        if(leftType=='UserIds'){
                            ...
                            }else if(righttype=='ActionIds'){
                                url = baseurl + '/roles/ajax_action_list/resourcecategory';
                            }
                        }
                        var leftdata = extractdata(lefttable);
                                ...
                                if (el.hasOwnProperty('AddRemove')) {
                                    if(el.Checked != null || (el.AddRemove == 'remove')){
                                        if (type == 'Permissions') {
                                            ...
                                            obj = {action: needale, AddRemove: 'remove'};
                                        }
                                        postdata.push(obj);
                                    }
                        ...
                        $(selectdata).each(function(i,el){
                            ...
                            if(is_inarray(needale,userpermission,'add',type)){
                                ...
                                if(type=='Users'){
                                    ...
                                    obj = {action:needale,AddRemove:'add'};
                                }
                                postdata.push(obj);
                            }
                        });
                    ...
                    function checkseletected(self,event){
                        ...
                        if(parent.hasClass('leftsection')) {
                            ...
                            if ($(table).find('input[type="checkbox"]:checked').length == 0) {                                
                                ...
                                resetcheckboxs('RoleIds', '.rightsection');
                                resetcheckboxs('ResourceIds', '.rightsection');
                                resetcheckboxs('ActionIds', '.rightsection');
                                return true;
                            }
                            getdata();
                        }
                    ...
                    $('#lefttab3 .resource tr').mouseover(function(){
                        var id = $(this).find('input[type="checkbox"]').val();
                        var txt = $(this).find('td').next('td').text();
                        $(this).find('td').next('td').find('span').show();
                    });
                    $('#lefttab3 .resource tr').mouseout(function(){
                        $(this).find('td').next('td').find('span').hide();
                    });
...
@section('footer_ext')
                    ...
                    <div class="modal-body">
                        <div class="row role">
                            <div class="col-md-12">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" name="ResourceCategoryName" type="text" >
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="edit-modal-role-permission">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="edit-role-permission-form" method="post">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
