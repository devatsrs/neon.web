        ...
        <div class="filter-inner">
            ...
            <form role="form" id="activecall-table-search" method="post"  action="{{Request::url()}}" class="form-horizontal form-groups-bordered validate" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="CLDPrefix" class="form-control mid_fld "  value="{{Input::get('prefix')}}"  />
                </div>
                <div class="form-group">
...
<br>
    ...
    <script type="text/javascript">
        var toFixed = '{{get_round_decimal_places()}}';
                ...
                var list_fields  = ['AccountName','CLI','CLD','CLDPrefix','ConnectTime','Cost','CompanyGatewayID'];
                var $searchFilter = {};
                var update_new_url;
                var postdata;
                jQuery(document).ready(function ($) {
                    ...
                    $searchFilter.AccountID = $("#activecall-table-search select[name='AccountID']").val();
                    $searchFilter.CLI = $("#activecall-table-search [name='CLI']").val();
                    $searchFilter.CLD = $("#activecall-table-search [name='CLD']").val();
                    $searchFilter.CLDPrefix = $("#activecall-table-search [name='CLDPrefix']").val();
                    $searchFilter.CallType = $("#activecall-table-search select[name='CallType']").val();
                    $searchFilter.TrunkID = $("#activecall-table-search select[name='TrunkID']").val();
                    $searchFilter.ServiceID = $("#activecall-table-search select[name='ServiceID']").val();
                    $searchFilter.CompanyGatewayID = $("#activecall-table-search select[name='CompanyGatewayID']").val();

                    data_table = $("#table-4").dataTable({
                        "bDestroy": true,
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": baseurl + "/ActiveCalls/ajax_datagrid/type",
                        "fnServerParams": function (aoData) {
                            aoData.push(
                                    {"name": "AccountID", "value": $searchFilter.AccountID},
                                    {"name": "CLI","value": $searchFilter.CLI},
                                    {"name": "CLD","value": $searchFilter.CLD},
                                    {"name": "CLDPrefix","value": $searchFilter.CLDPrefix},
                                    {"name": "CallType", "value": $searchFilter.CallType},
                                    {"name": "TrunkID","value": $searchFilter.TrunkID},
                                    {"name": "ServiceID","value": $searchFilter.ServiceID},
                            ...
                            "aButtons": [
                                {
                                    "sExtends": "download",
                                    "sButtonText": "EXCEL",
                                    "sUrl": baseurl + "/ActiveCalls/ajax_datagrid/xlsx", //baseurl + "/generate_xlsx.php",
                                    sButtonClass: "save-collection"
                                },
                                {
                                    "sExtends": "download",
                                    "sButtonText": "CSV",
                                    "sUrl": baseurl + "/ActiveCalls/ajax_datagrid/csv", //baseurl + "/generate_csv.php",
                                    sButtonClass: "save-collection"
                                }
                            ]
                        },
                    ...
                    //LoadActiveCalls
                    $("#LoadActiveCalls").on("click", function (e) {
                        e.preventDefault();
                        $.ajax({
