...
<ol class="breadcrumb bc-3">
  ...
  <li class="active"> <a href="javascript:void(0)">Account IP</a> </li>
</ol>
<h3>Account IP</h3>
...
<div style="overflow-y: auto;">
    ...
    <script type="text/javascript">
        var toFixed = '{{get_round_decimal_places()}}';
                ...
                var list_fields  = ['AccountName','RemoteIps','IPType'];
                var $searchFilter = {};
                var update_new_url;
                var postdata;
                jQuery(document).ready(function ($) {
                    ...
                    data_table = $("#table-4").dataTable({
                        ...
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": baseurl + "/VOS/AccountIP/ajax_datagrid/type",
                            ...
                            "aButtons": [
                                {
                                    "sExtends": "download",
                                    "sButtonText": "EXCEL",
                                    "sUrl": baseurl + "/VOS/AccountIP/ajax_datagrid/xlsx", //baseurl + "/generate_xlsx.php",
                                    sButtonClass: "save-collection"
                                },
                                {
                                    "sExtends": "download",
                                    "sButtonText": "CSV",
                                    "sUrl": baseurl + "/VOS/AccountIP/ajax_datagrid/csv", //baseurl + "/generate_csv.php",
                                    sButtonClass: "save-collection"
                                }
                            ]
                        },
