            ...
            <div class="panel panel-primary" data-collapsed="0">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <?php $BillingCycleTypearray = array( ""=>"Please Select an Option","weekly"=>"Weekly", "monthly"=>"Monthly" , "daily"=>"Daily", "in_specific_days"=>"In Specific days", "monthly_anniversary"=>"Monthly anniversary");?>
                                                        {{Form::select('BillingCycleType', $BillingCycleTypearray, $BillingCycleType,array("class"=>"form-control select2"))}}
                                                    </div>
