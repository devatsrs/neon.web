<script>
    $(document).ready(function ($) {
        ...
        $('#add-edit-itemtype-form').submit(function(e){
            ...
            var DIDCategoryID = $("#add-edit-itemtype-form [name='DIDCategoryID']").val();

            if( typeof DIDCategoryID != 'undefined' && DIDCategoryID != ''){
                update_new_url = baseurl + '/did/'+DIDCategoryID+'/update';
            }else{
                update_new_url = baseurl + '/did/create';
            }
                    ...
                    if( typeof data_table !=  'undefined'){
                        ...
                        $(datatype).each(function (key, el) {
                            ...
                            if(productsubscription==1){
                                NewProductID = '1-' + response.newcreated.DIDCategoryID;
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="field-5" class="control-label">Category Name *</label>
                    <input type="text" name="CategoryName" class="form-control" id="field-5" placeholder="">
                </div>
            </div>

        </div>
    </div>
    <input type="hidden" name="DIDCategoryID" />
