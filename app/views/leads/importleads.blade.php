...
@section('content')
    <ol class="breadcrumb bc-3">
        ...
        <li class="active"><strong>Import Leads</strong></li>
    </ol>    <h3>Import Leads</h3>

    <div class="row">
        <div class="col-md-12">
            <form role="form" id="form-upload" name="form-upload" method="post" action="{{URL::to('leads/process_upload')}}" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <p>Sample File <a class="btn btn-success btn-sm btn-icon icon-left" href="{{URL::to('leads/download_sample_excel_file')}}"><i class="entypo-down"></i>Download</a></p>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            $('.btn.upload').click(function(e){
                ...
                show_loading_bar(0);
                $.ajax({
                    url:  '{{URL::to('leads/check_upload')}}',  //Server script to process data
                    type: 'POST',
                    dataType: 'json',
                    beforeSend: function(){
            ...
            $("#save_template").click(function(e){
                ...
                $.ajax({
                    url:'{{URL::to('leads/storeTemplate')}}', //Server script to process data
                    type: 'POST',
                    dataType: 'json',
                    beforeSend: function(){
            ...
            function createGrid(data){
                ...
                if(data.LeadsFileUploadTemplate){
                    $.each( data.LeadsFileUploadTemplate, function( optionskey, option_value ) {
                        if(optionskey == 'Title'){
