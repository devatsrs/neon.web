        ...
        <form role="form" id="rategenerator-code-from" method="post" action="{{URL::to('rategenerators/rules/'.$id.'/update/'.$RateRuleID)}}" class="form-horizontal form-groups-bordered">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 row">
                            ...
                            <label for="field-1" class="col-sm-2 control-label">Code</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control popover-primary" name="DestinationCode"  id="field-1" placeholder="" value="{{$DestinationCode}}" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Enter either Destination Code Or Destination Description. Use * for all codes or description. For wildcard search use  e.g. 92* or india*." data-original-title="Destination Code/Description" />
                            </div>
                            <label for="field-1" class="col-sm-2 control-label">Description</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control popover-primary" name="DestinationDescription" id="field-2" placeholder="" value="{{$DestinationDescription}}" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Enter either Destination Code Or Destination Description. Use * for all codes or description. For wildcard search use  e.g. 92* or india*." data-original-title="Destination Code/Description"  />
                            </div>
                        </div>
                    </div>
