<div class="mail-sidebar">   
  ...
  <div>
    <div style="visibility:hidden;"  class="mail-sidebar-row hidden-xs"> <a href="{{URL::to('/emailmessages/compose')}}" class="btn btn-success btn-icon btn-block"> Compose Mail <i class="entypo-pencil"></i> </a> </div>
  </div>
  <!-- menu -->
  <ul class="mail-menu">
