    ...
    <div class="row">
      ...
      <p style="text-align: right;">
          @if(User::checkCategoryPermission('CDR','Delete') )
              <button id="delete-vendor-cdr" class="btn btn-danger btn-sm btn-icon icon-left" data-loading-text="Loading..."> <i class="entypo-cancel"></i> Delete Selected CDR </button>
          @endif
