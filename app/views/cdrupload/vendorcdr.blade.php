            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-2" style="width: 15%;">
                        <input type="text" name="StartDate" class="form-control datepicker end_date"  data-date-format="yyyy-mm-dd" value="{{Input::get('StartDate')}}" data-enddate="{{date('Y-m-d')}}" />
                    </div>
                    ...
                    <div class="col-sm-2" style=" width: 15%;">
                        <input type="text" name="EndDate" class="form-control datepicker end_date"  data-date-format="yyyy-mm-dd" value="{{Input::get('EndDate')}}" data-enddate="{{date('Y-m-d')}}" />
                    </div>
                    <div class="col-sm-1" style="padding: 0px; width: 11%;">
