...
.co-md-e1{ padding-left:8px;padding-right:8px;}
.co-md-e12{padding-left:5px;padding-right:5px; width:11%;}
</style>
<!--
<div class="row">
<div  class="col-md-12">
                    ...
                    <div id="cdrfilter" data-collapsed="0" class="panel panel-primary filter">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="co-md-1 control-label small_label" style="width: 9%;" for="field-1">Start Date</label>
                                <div class="co-md-2" style="padding-left:0; padding-right:0; width:10%;">
                                ...
                                <div class="co-md-1" style="padding: 0px; width: 9%;">
                                ...
                                <label class="co-md-1 control-label small_label" for="field-1" style="padding-left: 0px; width: 7%;">End Date</label>
                                <div class="co-md-2" style="padding-right: 0px; padding-left: 0px; width: 10%;">
                                ...
                                <label for="field-1" class="co-md-2 control-label" style="width: 6%;">Currency</label>
                                <div class="co-md-2">
                                ...
                                <label class="co-md-1 control-label small_label" for="field-1">Type</label>
                                <div class="co-md-2" style="padding-right: 0px; width: 14%;">
                            ...
                            <div class="form-group">
                                <label class="co-md-1 control-label" for="field-1">Gateway</label>
                                <div class="co-md-2">
                                    {{ Form::select('CompanyGatewayID',$gateway,Input::get('CompanyGatewayID'), array("class"=>"select2","id"=>"bluk_CompanyGatewayID")) }}
                                </div>
                                <label class="co-md-1 control-label" for="field-1">Account</label>
                                <div class="co-md-2">
                               ...
                               <label class="co-md-1 control-label" for="field-1" style="padding-right: 0px; padding-left: 0px; width: 4%;">CLI</label>
                               <div class="co-md-1 co-md-e1" style="width: 10%;">
                                    <input type="text" name="CLI" class="form-control mid_fld "  value=""  />
                                </div>
                                 <label class="co-md-1 control-label" for="field-1" style="padding-left: 0px; padding-right: 0px; width: 4%;">CLD</label>
                               <div class="co-md-1 co-md-e1" style="width: 10%;">
                                    <input type="text" name="CLD" class="form-control mid_fld  "  value=""  />
                                </div>

                                <label for="field-1" class="co-md-1 control-label" style="width: 4%;">Show</label>
                                <div class="co-md-2">
                            ...
                            <div class="form-group">
                                <label class="co-md-1 control-label" for="field-1">Prefix</label>
                                <div class="co-md-2">
                                ...
                                ?>
                                <label class="co-md-1 control-label" for="field-1">Trunk</label>
                                <div class="co-md-2">
