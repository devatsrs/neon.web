                        ...
                        <table id="EstimateTable" class="table table-bordered" style="margin-bottom: 0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{Form::textarea('EstimateDetail[Description][]',$ProductRow->Description,array("class"=>"form-control descriptions invoice_estimate_textarea"))}}</td>
...
-->                            <tr class="grand_total_estimate">
              ...
              <tr class="  @if($key==0) estimate_tax_row @else all_tax_row @endif">
                ...
                @else
                <td>
                 <button title="Delete Tax" type="button" class="btn btn-primary btn-xs estimate_tax_remove ">-</button>
                 </td>
                @endif  
