        ...
        function createGrid(data){
            ...
            $("#mapping #tab1 select").each(function(i, el){
                if(el.name !='selection[DateFormat]' && el.name != 'selection[DialCodeSeparator]' && el.name != 'selection[OriginationDialCodeSeparator]' && el.name != 'selection[FromCurrency]' && el.name != 'selection[CountryCodeSeparator]'){
                    ...
                    if (searchKeyByValue(this_column, currency_static_columns_timezone) === false && dual_mapping_columns_static.indexOf(this_column) == -1 && all_occupied_timezone_fields2.indexOf(this_column.replace('Currency','')) === -1) {
                    ...
                    if(optionskey == 'Options'){
                        ...
                        $.each( option_value.selection, function( key, value ) {
                            if(key == 'CountryMapping' || key == 'OriginationCountryMapping') {
                                ...
                                var all_components = ['OneOffCost','MonthlyCost','CostPerCall','CostPerMinute','SurchargePerCall','SurchargePerMinute','OutpaymentPerCall','OutpaymentPerMinute','Surcharges','Chargeback','CollectionCostAmount','CollectionCostPercentage','RegistrationCostPerNumber'];
