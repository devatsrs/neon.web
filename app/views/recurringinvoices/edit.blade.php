                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <!--  <td class="text-center">{{Form::text('RecurringInvoiceDetail[Discount][]',number_format($ProductRow->Discount,$RoundChargesAmount),array("class"=>"form-control Discount","data-min"=>"1", "data-mask"=>"fdecimal"))}}</td>-->
                                    <td class="text-center">{{Form::text('RecurringInvoiceDetail[DiscountAmount][]', number_format($ProductRow->DiscountAmount,$RoundChargesAmount),array("class"=>"form-control DiscountAmount","data-min"=>"1", "data-mask"=>"fdecimal"))}} {{Form::Select("RecurringInvoiceDetail[DiscountType][]",array("Percentage"=>"%","Flat"=>"Flat"),$ProductRow->DiscountType,array("class"=>"select2 small DiscountType"))}}</td>
                                    <td>{{Form::SelectExt(
                                            [
