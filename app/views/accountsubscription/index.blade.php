                           ...
                           "bSortable": false,
                            mRender: function ( id, type, full ) {
                                ...
                                console.log(list_fields[1]);
                                 ...
                                 action += '</div>';
                                 action += ' <a href="' + subscription_edit_url.replace("{id}",list_fields[0]) +'" title="Edit" class="edit-subscription btn btn-default btn-sm"><i class="entypo-pencil"></i>&nbsp;</a>'
                                 action += ' <a href="' + subscription_delete_url.replace("{id}",list_fields[0]) +'" title="Delete" class="delete-subscription btn btn-danger btn-sm"><i class="entypo-trash"></i></a>'
                                 return action;
                            }
                          }
                         ],
