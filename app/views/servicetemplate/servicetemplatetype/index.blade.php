...
@section('content')
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="customer_rate_tab_content">
            ...
            <div class="row">
                <div  class="col-md-12">
                    <a href="{{ URL::to('/servicesTemplate')  }}" class="btn btn-danger btn-md btn-icon icon-left pull-right" > <i class="entypo-cancel"></i> Close </a>
                    @if(User::checkCategoryPermission('SubscriptionTemplate','Edit'))
            ...
            <script type="text/javascript">
                ...
                jQuery(document).ready(function ($) {
                    ...
                    data_table = $("#table-4").dataTable({
                        ...
                        "bProcessing": true,
                        "bServerSide": true,
                        "sAjaxSource": baseurl + "/servicetempaltes/servicetemplatetype/getFields/type",
                        ...
                        "aoColumns": [
                            ...
                            {                       //  5  Action
                                ...
                                mRender: function (id, type, full) {
                                   ...
                                   var delete_ = "{{ URL::to('servicetempaltes/servicetemplatetype/dynamicfields/{id}/delete')}}";
                                    ...
                                    <?php } ?>
                                    if(full[3]==1) {
                                        <?php if(User::checkCategoryPermission('SubscriptionTemplate', 'View') ){ ?>
                            ...
                            "aButtons": [
                                {
                                    "sExtends": "download",
                                    "sButtonText": "EXCEL",
                                    "sUrl": baseurl + "/servicetempaltes/servicetemplatetype/getFields/xlsx",
                                    sButtonClass: "save-collection btn-sm"
                                },
                                {
                                    "sExtends": "download",
                                    "sButtonText": "CSV",
                                    "sUrl": baseurl + "/servicetempaltes/servicetemplatetype/getFields/csv",
                                    sButtonClass: "save-collection btn-sm"
                                }
                            ]
                        },
                    ...
                    $('.type_active_deactive').click(function(e) {
                        ...
                        item_update_status_url =  '{{ URL::to('servicetempaltes/servicetemplatetype/dynamicField/update_bulk_itemtypes_status')}}';
                        $.ajax({
    ...
    @include("servicetemplate.servicetemplatetype.productitemmodal")
@stop
