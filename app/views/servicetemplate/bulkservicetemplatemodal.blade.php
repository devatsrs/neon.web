  ...
  $(document).ready(function ($) {
      ...
      $.post(url, function (data, status) {
          ...
          if (OutboundDiscountPlanID) {
              $("#add-action-bulk-form [name='OutboundDiscountPlanIdBulkAction']").select2().select2('val', OutboundDiscountPlanID);
          }else {
      ...
      $.post(url, function (data, status) {
          ...
          if (InboundDiscountPlanID != null) {
              $("#add-action-bulk-form [name='InboundDiscountPlanIdBulkAction']").select2().select2('val', InboundDiscountPlanID);
          }else {
