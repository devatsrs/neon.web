CREATE TABLE `tblPayment` (
  ...
  `ModifyBy` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `RecallBy` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `CurrencyID` int(11) NOT NULL,
  `BulkUpload` tinyint(1) DEFAULT '0',
  `InvoiceID` int(11) NOT NULL DEFAULT '0',
  `TransactionID` varchar(155) COLLATE utf8_unicode_ci DEFAULT NULL,
