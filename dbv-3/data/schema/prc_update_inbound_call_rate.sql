...
/* Update Inbound Rate  */
   ...
   DEALLOCATE PREPARE stmt4;
  	...
  	set @stm5 = CONCAT('insert into tmp_Message_ 
								select  TempUsageDetailID, concat( "Prefix not found for " , GatewayAccountID )
							  from  ' , p_tbltempusagedetail_name  , ' where ProcessID = "' , p_processid  , '" and is_inbound = 1 and area_prefix = "Other"  ');
