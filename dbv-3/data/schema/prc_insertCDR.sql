...
BEGIN
	...
	set @stm3 = CONCAT('
	insert into tblUsageDetailFailedCall (UsageHeaderID,connect_time,disconnect_time,billed_duration,area_prefix,pincode,cli,cld,cost,remote_ip,duration,trunk,ProcessID,ID)
	select UsageHeaderID,connect_time,disconnect_time,billed_duration,area_prefix,pincode,cli,cld,cost,remote_ip,duration,trunk,ProcessID,ID
	...
	set @stm5 = CONCAT(' 
	insert into tblUsageDetails (UsageHeaderID,connect_time,disconnect_time,billed_duration,area_prefix,pincode,cli,cld,cost,remote_ip,duration,trunk,ProcessID,ID)
	select UsageHeaderID,connect_time,disconnect_time,billed_duration,area_prefix,pincode,cli,cld,cost,remote_ip,duration,trunk,ProcessID,ID
		 from  `' , p_tbltempusagedetail_name , '` d left join tblUsageHeader h	 on h.CompanyID = d.CompanyID
		AND h.CompanyGatewayID = d.CompanyGatewayID
		AND h.GatewayAccountID = d.GatewayAccountID
